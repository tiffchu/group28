...
![Decision Tree Confusion Matrix](/figures/dt_confusion.png){#fig-dt_confusion width=80%}

![K-NN Confusion Matrix](/figures/knn_confusion.png){#fig-knn_confusion width=80%}
